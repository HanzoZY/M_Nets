...
def train():
    ...
    if hparams.dataset == "omniglot":
        ...
        input_path = "/Users/zhangyuhan/Downloads/DataSet/omniglot/python/train.npz"
        valid_path = "/Users/zhangyuhan/Downloads/DataSet/omniglot/python/test.npz"
    ...
    with tf.Graph().as_default():
        ...
        with tf.variable_scope("networks"):
            ...
            gnn = M_Nets(hparams, embed_network.output, embed_network.label_placeholder, True)
        ...
        with tf.variable_scope("networks", reuse=True):
            ...
            valid_gnn= M_Nets(hparams, valid_embed_network.output, valid_embed_network.label_placeholder, False)
        params_to_str = f"M_Nets_{hparams.input_dim}_{hparams.lr}_{hparams.n}_{hparams.k}"
        ...
        with supervisor.managed_session(config=config) as sess:
            ...
            for step in range(STEP_NUM):
                ...
                if step % print_every != 0:
                    ...
                    loss, acc,simi,attention,target_label,predict_label = sess.run([valid_gnn.loss, valid_gnn.accuracy,valid_gnn.embeddings_similarity,valid_gnn.attention,valid_gnn.predict_label,valid_gnn.target_label])
